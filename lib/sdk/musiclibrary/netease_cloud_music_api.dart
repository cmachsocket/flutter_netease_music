...
class NeteaseCloudMusicApi {
  ...
  MusicResponse login_cellphone(String phone,
      {String? password,
      String? countrycode,
      String? md5_password,
      String? captcha,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/login/cellphone", cookie: cookie, env: env, query: {
      'phone': phone,
      'password': password,
  ...
  MusicResponse login(String email, String password,
      {String? md5_password,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/login", cookie: cookie, env: env, query: {
      'email': email,
      'password': password,
      'md5_password': md5_password
    });
  ...
  MusicResponse login_qr_key(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse login_qr_check(String key,
    ...
    return request("/login/qr/check",
        cookie: cookie, env: env, query: {'key': key, 'noCookie': noCookie});
  }
  ...
  MusicResponse register_anonimous(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/register/anonimous", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /login/refresh
  MusicResponse login_refresh(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/login/refresh", cookie: cookie, env: env);
  }
  ...
  MusicResponse captcha_sent(String phone,
      {String? ctcode,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/captcha/sent",
        cookie: cookie, env: env, query: {'phone': phone, 'ctcode': ctcode});
  }
  ...
  MusicResponse captcha_verify(String phone, String captcha,
      {String? ctcode,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/captcha/verify",
        cookie: cookie,
        env: env,
        query: {'phone': phone, 'captcha': captcha, 'ctcode': ctcode});
  }
  ...
  MusicResponse register_cellphone(
      String captcha, String phone, String password, String nickname,
      {String? countrycode,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/register/cellphone", cookie: cookie, env: env, query: {
      'captcha': captcha,
      'phone': phone,
      'password': password,
      'nickname': nickname,
  ...
  MusicResponse cellphone_existence_check(String phone,
      {String? countrycode,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/cellphone/existence/check",
        cookie: cookie,
        env: env,
        query: {'phone': phone, 'countrycode': countrycode});
  }
  ...
  MusicResponse activate_init_profile(String nickname,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/activate/init/profile",
        cookie: cookie, env: env, query: {'nickname': nickname});
  }
  ...
  MusicResponse nickname_check(String nickname,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/nickname/check",
        cookie: cookie, env: env, query: {'nickname': nickname});
  }
  ...
  MusicResponse rebind(String oldcaptcha, String captcha, String phone,
      {String? ctcode,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/rebind", cookie: cookie, env: env, query: {
  ...
  ///
  ///调用例子 : /logout
  MusicResponse logout(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/logout", cookie: cookie, env: env);
  }
  ...
  ///
  ///接口地址 : /login/status
  MusicResponse login_status(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/login/status", cookie: cookie, env: env);
  }
  ...
  MusicResponse user_detail(String uid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/detail",
        cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  ///
  ///调用例子 : /user/account
  MusicResponse user_account(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/account", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /user/subcount
  MusicResponse user_subcount(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/subcount", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /user/level
  MusicResponse user_level(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/level", cookie: cookie, env: env);
  }
  ...
  MusicResponse user_binding(String uid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/binding",
        cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  MusicResponse user_replacephone(
      String phone, String oldcaptcha, String captcha,
      {String? countrycode,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/replacephone", cookie: cookie, env: env, query: {
      'phone': phone,
      'oldcaptcha': oldcaptcha,
      'captcha': captcha,
      'countrycode': countrycode
  ...
  MusicResponse user_update(String gender, String birthday, String nickname,
      String province, String city, String signature,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/update", cookie: cookie, env: env, query: {
      'gender': gender,
      'birthday': birthday,
      'nickname': nickname,
      'province': province,
  ...
  MusicResponse avatar_upload(
    ...
    return request("/avatar/upload",
        cookie: cookie,
        env: env,
        query: {'imgSize': imgSize, 'imgX': imgX, 'imgY': imgY});
  }
  ...
  ///
  ///调用例子 : /pl/count
  MusicResponse pl_count(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/pl/count", cookie: cookie, env: env);
  }
  ...
  MusicResponse countries_code_list(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/countries/code/list", cookie: cookie, env: env);
  }
  ...
  MusicResponse user_playlist(String uid,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/playlist",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse playlist_update(
      String id, String name, String desc, String tags,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/update",
        cookie: cookie,
        env: env,
        query: {'id': id, 'name': name, 'desc': desc, 'tags': tags});
  }
  ...
  MusicResponse playlist_desc_update(String id, String desc,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/desc/update",
        cookie: cookie, env: env, query: {'id': id, 'desc': desc});
  }
  ...
  MusicResponse playlist_name_update(String id, String name,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/name/update",
        cookie: cookie, env: env, query: {'id': id, 'name': name});
  }
  ...
  MusicResponse playlist_tags_update(String id, String tags,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/tags/update",
        cookie: cookie, env: env, query: {'id': id, 'tags': tags});
  }
  ...
  MusicResponse playlist_cover_update(String id,
      {String? imgSize,
      String? imgX,
      String? imgY,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/playlist/cover/update",
        cookie: cookie,
        env: env,
        query: {'id': id, 'imgSize': imgSize, 'imgX': imgX, 'imgY': imgY});
  }
  ...
  MusicResponse playlist_order_update(String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/order/update",
  ...
  MusicResponse song_order_update(String pid, String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/order/update",
        cookie: cookie, env: env, query: {'pid': pid, 'ids': ids});
  }
  ...
  MusicResponse user_comment_history(String uid,
      {String? limit,
      String? time,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/comment/history",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'limit': limit, 'time': time});
  }
  ...
  MusicResponse user_dj(String uid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/dj", cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  MusicResponse user_follows(String uid,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse user_followeds(String uid,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/followeds",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'limit': limit, 'offset': offset});
  }
  ...
  ///41、21 分享视频
  ///
  MusicResponse user_event(String uid,
      {String? limit,
      String? lasttime,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/event",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'limit': limit, 'lasttime': lasttime});
  }
  ...
  MusicResponse event_forward(String uid, String evId, String forwards,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/event/forward",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'evId': evId, 'forwards': forwards});
  }
  ...
  MusicResponse event_del(String evId,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/event/del",
        cookie: cookie, env: env, query: {'evId': evId});
  }
  ...
  MusicResponse share_resource(String id,
      {String? type,
      String? msg,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/share/resource",
        cookie: cookie, env: env, query: {'id': id, 'type': type, 'msg': msg});
  }
  ...
  MusicResponse comment_event(String threadId,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/comment/event",
        cookie: cookie, env: env, query: {'threadId': threadId});
  }
  ...
  MusicResponse follow(String id, String t,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/follow",
        cookie: cookie, env: env, query: {'id': id, 't': t});
  }
  ...
  MusicResponse user_record(String uid,
      {String? type,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/record",
        cookie: cookie, env: env, query: {'uid': uid, 'type': type});
  }
  ...
  MusicResponse hot_topic(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/hot/topic",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse topic_detail(
      {String? actid,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/topic/detail",
        cookie: cookie, env: env, query: {'actid': actid});
  }
  ...
  MusicResponse topic_detail_event_hot(
      {String? actid,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/topic/detail/event/hot",
        cookie: cookie, env: env, query: {'actid': actid});
  }
  ...
  MusicResponse comment_hotwall_list(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/comment/hotwall/list", cookie: cookie, env: env);
  }
  ...
  MusicResponse playmode_intelligence_list(String id, String pid,
      {String? sid,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/playmode/intelligence/list",
        cookie: cookie, env: env, query: {'id': id, 'pid': pid, 'sid': sid});
  }
  ...
  MusicResponse event(String pagesize, String lasttime,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/event",
        cookie: cookie,
        env: env,
        query: {'pagesize': pagesize, 'lasttime': lasttime});
  }
  ...
  MusicResponse artist_list(
      ...
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/artist/list", cookie: cookie, env: env, query: {
      'limit': limit,
      'offset': offset,
      'initial': initial,
      'type': type,
  ...
  MusicResponse artist_sub(String id, String t,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse artist_top_song(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/artist/top/song",
  ...
  MusicResponse artist_songs(String id,
      {String? order,
      String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/artist/songs",
        cookie: cookie,
        env: env,
        query: {'id': id, 'order': order, 'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse topic_sublist(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/topic/sublist",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  ///
  ///调用例子 : /video/sub
  MusicResponse video_sub(String id, String t,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/video/sub",
        cookie: cookie, env: env, query: {'id': id, 't': t});
  }
  ...
  ///
  ///调用例子 : /mv/sub
  MusicResponse mv_sub(String mvid, String t,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/mv/sub",
        cookie: cookie, env: env, query: {'mvid': mvid, 't': t});
  }
  ...
  ///
  ///调用例子 : /mv/sublist
  MusicResponse mv_sublist(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/mv/sublist", cookie: cookie, env: env);
  }
  ...
  MusicResponse playlist_catlist(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/catlist", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /playlist/hot
  MusicResponse playlist_hot(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/hot", cookie: cookie, env: env);
  }
  ...
  MusicResponse top_playlist(
    ...
    return request("/top/playlist",
        cookie: cookie,
        env: env,
        query: {'order': order, 'cat': cat, 'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse playlist_highquality_tags(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/highquality/tags", cookie: cookie, env: env);
  }
  ...
  MusicResponse top_playlist_highquality(
      {String? cat,
      String? limit,
      String? before,
      Map<String, String> cookie = const {},
    ...
    return request("/top/playlist/highquality",
        cookie: cookie,
        env: env,
        query: {'cat': cat, 'limit': limit, 'before': before});
  }
  ...
  MusicResponse related_playlist(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/related/playlist",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse playlist_detail(String id,
      {String? s, Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/detail",
        cookie: cookie, env: env, query: {'id': id, 's': s});
  }
  ...
  MusicResponse playlist_detail_dynamic(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/detail/dynamic",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse playlist_update_playcount(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/update/playcount",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse song_url(String id,
      {String? br, Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/url",
        cookie: cookie, env: env, query: {'id': id, 'br': br});
  }
  ...
  MusicResponse song_url_v1(String id, String level,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/url/v1",
        cookie: cookie, env: env, query: {'id': id, 'level': level});
  }
  ...
  MusicResponse check_music(String id,
      {String? br, Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse search_hot_detail(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/search/hot/detail", cookie: cookie, env: env);
  }
  ...
  MusicResponse search_suggest(String keywords,
      {String? type,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/search/suggest",
        cookie: cookie, env: env, query: {'keywords': keywords, 'type': type});
  }
  ...
  MusicResponse search_multimatch(String keywords,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/search/multimatch",
        cookie: cookie, env: env, query: {'keywords': keywords});
  }
  ...
  MusicResponse playlist_create(String name,
      {String? privacy,
      String? type,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/playlist/create",
        cookie: cookie,
        env: env,
        query: {'name': name, 'privacy': privacy, 'type': type});
  }
  ...
  MusicResponse playlist_delete(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/delete",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse playlist_subscribe(String t, String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/subscribe",
        cookie: cookie, env: env, query: {'t': t, 'id': id});
  }
  ...
  MusicResponse playlist_subscribers(String id,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse playlist_tracks(String op, String pid, String tracks,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/tracks",
        cookie: cookie,
        env: env,
        query: {'op': op, 'pid': pid, 'tracks': tracks});
  }
  ...
  MusicResponse playlist_track_add(String pid, String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/track/add",
        cookie: cookie, env: env, query: {'pid': pid, 'ids': ids});
  }
  ...
  MusicResponse playlist_track_delete(String pid, String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/track/delete",
        cookie: cookie, env: env, query: {'pid': pid, 'ids': ids});
  }
  ...
  MusicResponse playlist_video_recent(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/video/recent", cookie: cookie, env: env);
  }
  ...
  MusicResponse lyric(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/lyric", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse lyric_new(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/lyric/new", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse top_song(String type,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse homepage_block_page(
      {String? refresh,
      String? cursor,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/homepage/block/page",
        cookie: cookie,
        env: env,
        query: {'refresh': refresh, 'cursor': cursor});
  }
  ...
  MusicResponse homepage_dragon_ball(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/homepage/dragon/ball", cookie: cookie, env: env);
  }
  ...
  MusicResponse comment_music(String id,
      {String? limit,
      String? offset,
      String? before,
      Map<String, String> cookie = const {},
    ...
    return request("/comment/music",
        cookie: cookie,
        env: env,
        query: {'id': id, 'limit': limit, 'offset': offset, 'before': before});
  }
  ...
  MusicResponse comment_floor(String parentCommentId, String id, String type,
      {String? limit,
      String? time,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse comment_mv(String id,
      {String? limit,
      String? offset,
      String? before,
      Map<String, String> cookie = const {},
  ...
  MusicResponse comment_dj(String id,
      {String? limit,
      String? offset,
      String? before,
      Map<String, String> cookie = const {},
  ...
  MusicResponse comment_video(String id,
      {String? limit,
      String? offset,
      String? before,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/comment/video",
        cookie: cookie,
        env: env,
        query: {'id': id, 'limit': limit, 'offset': offset, 'before': before});
  }
  ...
  MusicResponse comment_hot(String id, String type,
      {String? limit,
      String? offset,
      String? before,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/comment/hot", cookie: cookie, env: env, query: {
      'id': id,
      'type': type,
      'limit': limit,
      'offset': offset,
  ...
  MusicResponse comment_new(String id, String type,
      {String? pageNo,
      String? pageSize,
      String? sortType,
      String? cursor,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/comment/new", cookie: cookie, env: env, query: {
      'id': id,
      'type': type,
      'pageNo': pageNo,
      'pageSize': pageSize,
  ...
  MusicResponse comment_like(String id, String cid, String t, String type,
      {String? threadId,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/comment/like", cookie: cookie, env: env, query: {
      'id': id,
      'cid': cid,
      't': t,
      'type': type,
  ...
  MusicResponse hug_comment(String uid, String cid, String sid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/hug/comment",
        cookie: cookie, env: env, query: {'uid': uid, 'cid': cid, 'sid': sid});
  }
  ...
  MusicResponse comment_hug_list(String uid, String cid, String sid,
      {String? page,
      String? cursor,
      String? idCursor,
      String? pageSize,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/comment/hug/list", cookie: cookie, env: env, query: {
      'uid': uid,
      'cid': cid,
      'sid': sid,
      'page': page,
  ...
  MusicResponse comment(String t, String type, String id, String content,
      {String? commentId,
      String? threadId,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/comment", cookie: cookie, env: env, query: {
      't': t,
      'type': type,
      'id': id,
      'content': content,
  ...
  MusicResponse banner(
      {String? type,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/banner", cookie: cookie, env: env, query: {'type': type});
  }
  ...
  MusicResponse resource_like(String type, String t,
      {String? id,
      String? threadId,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/resource/like",
        cookie: cookie,
        env: env,
        query: {'type': type, 't': t, 'id': id, 'threadId': threadId});
  }
  ...
  MusicResponse playlist_mylike(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/mylike", cookie: cookie, env: env);
  }
  ...
  ///maxBrLevel；歌曲最高音质
  ///
  MusicResponse song_detail(String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  ///
  ///调用例子 : /album?id=32311
  MusicResponse album(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/album", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse album_detail_dynamic(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/album/detail/dynamic",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse album_sub(String id, String t,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/album/sub",
        cookie: cookie, env: env, query: {'id': id, 't': t});
  }
  ...
  MusicResponse artists(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/artists", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse artist_mv(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/artist/mv", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse artist_album(String id,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse artist_desc(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/artist/desc", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse simi_artist(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/simi/artist", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse simi_playlist(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/simi/playlist",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse simi_mv(String mvid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/simi/mv", cookie: cookie, env: env, query: {'mvid': mvid});
  }
  ...
  MusicResponse simi_song(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/simi/song", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse simi_user(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/simi/user", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse recommend_resource(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/recommend/resource", cookie: cookie, env: env);
  }
  ...
  MusicResponse recommend_songs(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/recommend/songs", cookie: cookie, env: env);
  }
  ...
  ///}
  ///
  MusicResponse recommend_songs_dislike(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/recommend/songs/dislike",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse history_recommend_songs(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/history/recommend/songs", cookie: cookie, env: env);
  }
  ...
  MusicResponse history_recommend_songs_detail(String date,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/history/recommend/songs/detail",
        cookie: cookie, env: env, query: {'date': date});
  }
  ...
  MusicResponse personal_fm(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/personal_fm", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /daily_signin
  MusicResponse daily_signin(
      {String? type,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/daily_signin",
        cookie: cookie, env: env, query: {'type': type});
  }
  ...
  MusicResponse sign_happy_info(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/sign/happy/info", cookie: cookie, env: env);
  }
  ...
  MusicResponse like(String id,
      {String? like,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/like",
        cookie: cookie, env: env, query: {'id': id, 'like': like});
  }
  ...
  MusicResponse likelist(String uid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/likelist", cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  MusicResponse fm_trash(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/fm_trash", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse top_album(
    ...
    return request("/top/album",
        cookie: cookie,
        env: env,
        query: {'area': area, 'type': type, 'year': year, 'month': month});
  }
  ...
  MusicResponse album_new(
    ...
    return request("/album/new",
        cookie: cookie,
        env: env,
        query: {'limit': limit, 'offset': offset, 'area': area});
  }
  ...
  ///
  ///调用例子 : /album/newest
  MusicResponse album_newest(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/album/newest", cookie: cookie, env: env);
  }
  ...
  MusicResponse scrobble(String id, String sourceid,
      {String? time,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/scrobble",
        cookie: cookie,
        env: env,
        query: {'id': id, 'sourceid': sourceid, 'time': time});
  }
  ...
  MusicResponse mv_all(
      ...
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/mv/all", cookie: cookie, env: env, query: {
      'area': area,
      'type': type,
      'order': order,
      'limit': limit,
  ...
  MusicResponse mv_first(
      {String? area,
      String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/mv/first",
        cookie: cookie, env: env, query: {'area': area, 'limit': limit});
  }
  ...
  MusicResponse mv_exclusive_rcmd(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/mv/exclusive/rcmd",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse personalized_mv(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/personalized/mv", cookie: cookie, env: env);
  }
  ...
  MusicResponse personalized(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/personalized",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse personalized_newsong(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse personalized_djprogram(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/personalized/djprogram", cookie: cookie, env: env);
  }
  ...
  MusicResponse program_recommend(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse personalized_privatecontent(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/personalized/privatecontent", cookie: cookie, env: env);
  }
  ...
  MusicResponse personalized_privatecontent_list(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse top_mv(
      {String? limit,
      String? area,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/top/mv",
        cookie: cookie,
        env: env,
        query: {'limit': limit, 'area': area, 'offset': offset});
  }
  ...
  MusicResponse mv_detail(String mvid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/mv/detail",
        cookie: cookie, env: env, query: {'mvid': mvid});
  }
  ...
  MusicResponse mv_detail_info(String mvid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse mv_url(String id,
      {String? r, Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/mv/url",
        cookie: cookie, env: env, query: {'id': id, 'r': r});
  }
  ...
  MusicResponse video_group_list(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/video/group/list", cookie: cookie, env: env);
  }
  ...
  MusicResponse video_category_list(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/video/category/list", cookie: cookie, env: env);
  }
  ...
  MusicResponse video_group(String id,
      {String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/video/group",
        cookie: cookie, env: env, query: {'id': id, 'offset': offset});
  }
  ...
  MusicResponse video_timeline_all(
      {String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/video/timeline/all",
        cookie: cookie, env: env, query: {'offset': offset});
  }
  ...
  MusicResponse video_timeline_recommend(
      {String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/video/timeline/recommend",
        cookie: cookie, env: env, query: {'offset': offset});
  }
  ...
  MusicResponse related_allvideo(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse video_detail_info(String vid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/video/detail/info",
        cookie: cookie, env: env, query: {'vid': vid});
  }
  ...
  MusicResponse video_url(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/video/url", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  ///
  ///调用例子 : /toplist
  MusicResponse toplist(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/toplist", cookie: cookie, env: env);
  }
  ...
  MusicResponse top_list(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/top/list", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  ///
  ///调用例子 : /toplist/detail
  MusicResponse toplist_detail(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/toplist/detail", cookie: cookie, env: env);
  }
  ...
  MusicResponse user_cloud_detail(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/cloud/detail",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  ///
  ///调用例子 : /user/cloud/del
  MusicResponse user_cloud_del(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/cloud/del",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse cloud(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/cloud", cookie: cookie, env: env);
  }
  ...
  MusicResponse cloud_match(String uid, String sid, String asid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/cloud/match",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'sid': sid, 'asid': asid});
  }
  ...
  ///
  ///调用例子 : /dj/banner
  MusicResponse dj_banner(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/banner", cookie: cookie, env: env);
  }
  ...
  MusicResponse dj_personalize_recommend(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse dj_subscriber(String id,
      {String? time,
      String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/subscriber",
        cookie: cookie,
        env: env,
        query: {'id': id, 'time': time, 'limit': limit});
  }
  ...
  MusicResponse user_audio(String uid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/audio",
        cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  MusicResponse dj_program_toplist(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse dj_toplist_pay(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/toplist/pay",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse dj_program_toplist_hours(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/program/toplist/hours",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse dj_toplist_hours(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/toplist/hours",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse dj_toplist_newcomer(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/toplist/newcomer",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse dj_toplist_popular(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse dj_toplist(
      {String? limit,
      String? offset,
      String? type,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/toplist",
        cookie: cookie,
        env: env,
  ...
  MusicResponse dj_radio_hot(
      {String? limit,
      String? offset,
      String? cateId,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/radio/hot",
        cookie: cookie,
        env: env,
        query: {'limit': limit, 'offset': offset, 'cateId': cateId});
  }
  ...
  ///
  ///调用例子 : /dj/recommend
  MusicResponse dj_recommend(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/recommend", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /dj/catelist
  MusicResponse dj_catelist(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/catelist", cookie: cookie, env: env);
  }
  ...
  MusicResponse dj_recommend_type(String type,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse dj_sub(String rid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/sub", cookie: cookie, env: env, query: {'rid': rid});
  }
  ...
  ///
  ///调用例子 : /dj/sublist
  MusicResponse dj_sublist(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/sublist", cookie: cookie, env: env);
  }
  ...
  MusicResponse dj_paygift(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/paygift",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse dj_category_excludehot(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/category/excludehot", cookie: cookie, env: env);
  }
  ...
  MusicResponse dj_category_recommend(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/category/recommend", cookie: cookie, env: env);
  }
  ...
  MusicResponse dj_today_perfered(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/today/perfered", cookie: cookie, env: env);
  }
  ...
  MusicResponse dj_detail(String rid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/detail", cookie: cookie, env: env, query: {'rid': rid});
  }
  ...
  MusicResponse dj_program(String rid,
      {String? limit,
      String? offset,
      String? asc,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/dj/program",
        cookie: cookie,
        env: env,
        query: {'rid': rid, 'limit': limit, 'offset': offset, 'asc': asc});
  }
  ...
  MusicResponse dj_program_detail(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/dj/program/detail",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse msg_private(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/msg/private",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse send_text(String user_ids, String msg,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/send/text",
        cookie: cookie, env: env, query: {'user_ids': user_ids, 'msg': msg});
  }
  ...
  MusicResponse send_song(String user_ids, String id, String msg,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/send/song",
        cookie: cookie,
        env: env,
        query: {'user_ids': user_ids, 'id': id, 'msg': msg});
  }
  ...
  MusicResponse send_album(String user_ids, String id, String msg,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/send/album",
        cookie: cookie,
        env: env,
        query: {'user_ids': user_ids, 'id': id, 'msg': msg});
  }
  ...
  MusicResponse send_playlist(String user_ids, String msg,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/send/playlist",
        cookie: cookie, env: env, query: {'user_ids': user_ids, 'msg': msg});
  }
  ...
  MusicResponse msg_recentcontact(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/msg/recentcontact", cookie: cookie, env: env);
  }
  ...
  MusicResponse msg_private_history(String uid,
      {String? limit,
      String? before,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/msg/private/history",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'limit': limit, 'before': before});
  }
  ...
  MusicResponse msg_comments(String uid,
      {String? limit,
      String? before,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/msg/comments",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'limit': limit, 'before': before});
  }
  ...
  MusicResponse msg_forwards(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/msg/forwards",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse msg_notices(
      {String? limit,
      String? lasttime,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/msg/notices",
        cookie: cookie,
        env: env,
        query: {'limit': limit, 'lasttime': lasttime});
  }
  ...
  ///
  ///调用例子 : /setting
  MusicResponse setting(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/setting", cookie: cookie, env: env);
  }
  ...
  MusicResponse album_songsaleboard(
      {String? limit,
      String? offset,
      String? albumType,
      String? type,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/album_songsaleboard", cookie: cookie, env: env, query: {
      'limit': limit,
      'offset': offset,
      'albumType': albumType,
      'type': type
  ...
  MusicResponse album_list_style(
      {String? limit,
      String? offset,
      String? area,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/album/list/style",
        cookie: cookie,
        env: env,
        query: {'limit': limit, 'offset': offset, 'area': area});
  }
  ...
  MusicResponse digitalAlbum_purchased(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/digitalAlbum/purchased",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse digitalAlbum_ordering(
      String id, String payment, String quantity,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/digitalAlbum/ordering",
        cookie: cookie,
        env: env,
        query: {'id': id, 'payment': payment, 'quantity': quantity});
  }
  ...
  MusicResponse calendar(String startTime, String endTime,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  ///
  ///调用例子 : /yunbei
  MusicResponse yunbei(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/yunbei", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /yunbei/today
  MusicResponse yunbei_today(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/yunbei/today", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /yunbei/sign
  MusicResponse yunbei_sign(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/yunbei/sign", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /yunbei/info
  MusicResponse yunbei_info(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/yunbei/info", cookie: cookie, env: env);
  }
  ...
  ///
  ///调用例子 : /yunbei/tasks
  MusicResponse yunbei_tasks(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/yunbei/tasks", cookie: cookie, env: env);
  }
  ...
  MusicResponse yunbei_tasks_todo(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/yunbei/tasks/todo", cookie: cookie, env: env);
  }
  ...
  MusicResponse yunbei_task_finish(String userTaskId,
      {String? depositCode,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/yunbei/task/finish",
        cookie: cookie,
        env: env,
        query: {'userTaskId': userTaskId, 'depositCode': depositCode});
  }
  ...
  MusicResponse yunbei_tasks_receipt(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/yunbei/tasks/receipt",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse yunbei_tasks_expense(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/yunbei/tasks/expense",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse artist_new_song(
      {String? limit,
      String? before,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/artist/new/song",
        cookie: cookie, env: env, query: {'limit': limit, 'before': before});
  }
  ...
  MusicResponse artist_new_mv(
      {String? limit,
      String? before,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/artist/new/mv",
        cookie: cookie, env: env, query: {'limit': limit, 'before': before});
  }
  ...
  ///主机模式: 检查房间当前状态
  ///从机模式: 待整理
  MusicResponse listentogether_room_check(String roomId,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listentogether/room/check",
        cookie: cookie, env: env, query: {'roomId': roomId});
  }
  ...
  ///主机模式: 用户加入房间
  ///从机模式: 待整理
  MusicResponse listentogether_accept(String roomId, String inviterId,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listentogether/accept",
        cookie: cookie,
        env: env,
        query: {'roomId': roomId, 'inviterId': inviterId});
  }
  ...
  ///主机模式: 创建新房间
  ///从机模式: 待整理
  MusicResponse listentogether_room_create(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listentogether/room/create", cookie: cookie, env: env);
  }
  ...
  ///主机模式: 获取房间同步歌单
  ///从机模式: 待整理
  MusicResponse listentogether_sync_playlist_get(String roomId,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listentogether/sync/playlist/get",
        cookie: cookie, env: env, query: {'roomId': roomId});
  }
  ...
  ///主机模式: 获取房间在线用户
  ///从机模式: 待整理
  MusicResponse listentogether_status(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listentogether/status", cookie: cookie, env: env);
  }
  ...
  ///主机模式: 关闭房间
  ///从机模式: 待整理
  MusicResponse listentogether_end(String roomId,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listentogether/end",
        cookie: cookie, env: env, query: {'roomId': roomId});
  }
  ...
  ///主机模式: 歌单同步到房间
  ///从机模式: 待整理
  MusicResponse listentogether_sync_list_command(
      String roomId,
      String commandType,
      String userId,
      String version,
      ...
      {Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/listentogether/sync/list/command",
        cookie: cookie,
        env: env,
        query: {
          'roomId': roomId,
  ...
  ///主机模式: 播放控制同步
  ///从机模式: 待整理
  MusicResponse listentogether_play_command(
      String roomId,
      String progress,
      String commandType,
      String formerSongId,
      ...
      {Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/listentogether/play/command",
        cookie: cookie,
        env: env,
        query: {
          'roomId': roomId,
  ...
  MusicResponse batch(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/batch", cookie: cookie, env: env);
  }
  ...
  MusicResponse yunbei_rcmd_song(String id,
      {String? reason,
      String? yunbeiNum,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/yunbei/rcmd/song",
        cookie: cookie,
        env: env,
        query: {'id': id, 'reason': reason, 'yunbeiNum': yunbeiNum});
  }
  ...
  MusicResponse yunbei_rcmd_song_history(
      {String? size,
      String? cursor,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/yunbei/rcmd/song/history",
        cookie: cookie, env: env, query: {'size': size, 'cursor': cursor});
  }
  ...
  MusicResponse song_purchased(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/song/purchased",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse mlog_url(String id,
      {String? res,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/mlog/url",
        cookie: cookie, env: env, query: {'id': id, 'res': res});
  }
  ...
  MusicResponse mlog_to_video(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/mlog/to/video",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse vip_growthpoint(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/vip/growthpoint", cookie: cookie, env: env);
  }
  ...
  MusicResponse vip_growthpoint_details(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/vip/growthpoint/details",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  ///
  ///调用例子 : /vip/tasks
  MusicResponse vip_tasks(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/vip/tasks", cookie: cookie, env: env);
  }
  ...
  MusicResponse vip_growthpoint_get(String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/vip/growthpoint/get",
        cookie: cookie, env: env, query: {'ids': ids});
  }
  ...
  MusicResponse artist_fans(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/artist/fans", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse artist_follow_count(String id,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/artist/follow/count",
        cookie: cookie,
        env: env,
        query: {'id': id, 'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse digitalAlbum_detail(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/digitalAlbum/detail",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse digitalAlbum_sales(String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/digitalAlbum/sales",
        cookie: cookie, env: env, query: {'ids': ids});
  }
  ...
  MusicResponse musician_data_overview(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/musician/data/overview", cookie: cookie, env: env);
  }
  ...
  MusicResponse musician_play_trend(String startTime, String endTime,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/musician/play/trend",
        cookie: cookie,
        env: env,
        query: {'startTime': startTime, 'endTime': endTime});
  }
  ...
  ///
  ///调用例子 : /musician/tasks
  MusicResponse musician_tasks(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/musician/tasks", cookie: cookie, env: env);
  }
  ...
  MusicResponse musician_tasks_new(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/musician/tasks/new", cookie: cookie, env: env);
  }
  ...
  MusicResponse musician_cloudbean(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/musician/cloudbean", cookie: cookie, env: env);
  }
  ...
  MusicResponse musician_cloudbean_obtain(String id, String period,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/musician/cloudbean/obtain",
        cookie: cookie, env: env, query: {'id': id, 'period': period});
  }
  ...
  MusicResponse vip_info(
      {String? uid,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/vip/info", cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  ///
  ///调用例子 : /musician/sign
  MusicResponse musician_sign(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/musician/sign", cookie: cookie, env: env);
  }
  ...
  MusicResponse mlog_music_rcmd(String songid,
      {String? mvid,
      String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/mlog/music/rcmd",
        cookie: cookie,
        env: env,
        query: {'songid': songid, 'mvid': mvid, 'limit': limit});
  }
  ...
  MusicResponse playlist_privacy(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/privacy",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse song_download_url(String id,
      {String? br, Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse artist_video(String id,
      {String? size,
      String? cursor,
      String? order,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/artist/video",
        cookie: cookie,
        env: env,
        query: {'id': id, 'size': size, 'cursor': cursor, 'order': order});
  }
  ...
  MusicResponse record_recent_song(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
  ...
  MusicResponse record_recent_video(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/record/recent/video",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse record_recent_voice(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/record/recent/voice",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse record_recent_playlist(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/record/recent/playlist",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse record_recent_album(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/record/recent/album",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse record_recent_dj(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/record/recent/dj",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse signin_progress(
      {String? moduleId,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/signin/progress",
        cookie: cookie, env: env, query: {'moduleId': moduleId});
  }
  ...
  ///
  ///调用例子 : /inner/version
  MusicResponse inner_version(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/inner/version", cookie: cookie, env: env);
  }
  ...
  MusicResponse vip_timemachine(
      {String? startTime,
      String? endTime,
      String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/vip/timemachine",
        cookie: cookie,
        env: env,
        query: {'startTime': startTime, 'endTime': endTime, 'limit': limit});
  }
  ...
  MusicResponse song_wiki_summary(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/wiki/summary",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse sheet_list(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/sheet/list", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse sheet_preview(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/sheet/preview",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  ///
  ///调用例子: /style/list
  MusicResponse style_list(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/style/list", cookie: cookie, env: env);
  }
  ...
  MusicResponse style_preference(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/style/preference", cookie: cookie, env: env);
  }
  ...
  MusicResponse style_detail(String tagId,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/style/detail",
        cookie: cookie, env: env, query: {'tagId': tagId});
  }
  ...
  MusicResponse style_song(String tagId,
      {String? size,
      String? cursor,
      String? sort,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/style/song",
        cookie: cookie,
        env: env,
        query: {'tagId': tagId, 'size': size, 'cursor': cursor, 'sort': sort});
  }
  ...
  MusicResponse style_album(String tagId,
      {String? size,
      String? cursor,
      String? sort,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/style/album",
        cookie: cookie,
        env: env,
        query: {'tagId': tagId, 'size': size, 'cursor': cursor, 'sort': sort});
  }
  ...
  MusicResponse style_playlist(String tagId,
      {String? size,
      String? cursor,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/style/playlist",
        cookie: cookie,
        env: env,
        query: {'tagId': tagId, 'size': size, 'cursor': cursor});
  }
  ...
  MusicResponse style_artist(String tagId,
      {String? size,
      String? cursor,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/style/artist",
        cookie: cookie,
        env: env,
        query: {'tagId': tagId, 'size': size, 'cursor': cursor});
  }
  ...
  MusicResponse starpick_comments_summary(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/starpick/comments/summary", cookie: cookie, env: env);
  }
  ...
  MusicResponse aidj_content_rcmd(
      {String? longitude,
      String? latitude,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/aidj/content/rcmd",
        cookie: cookie,
        env: env,
  ...
  ///
  ///必选参数： id : 歌曲 ID
  MusicResponse music_first_listen_info(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/music/first/listen/info",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  ///
  ///podcastName: 播客名称
  MusicResponse voicelist_search(
      {String? limit,
      String? offset,
      String? podcastName,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/voicelist/search",
        cookie: cookie,
        env: env,
        query: {'limit': limit, 'offset': offset, 'podcastName': podcastName});
  }
  ...
  ///
  ///offset: 偏移数量 , 用于分页 , 如 :( 评论页数 -1)\*200, 其中 200 为 limit 的值
  MusicResponse voicelist_list(String voiceListId,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/voicelist/list",
        cookie: cookie,
        env: env,
        query: {'voiceListId': voiceListId, 'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse voicelist_list_search(
      ...
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/voicelist/list/search", cookie: cookie, env: env, query: {
  ...
  ///同上
  ///
  MusicResponse voice_detail(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/voice/detail",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse voicelist_trans(String limit, String offset, String position,
      String programId, String radioId,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/voicelist/trans", cookie: cookie, env: env, query: {
      'limit': limit,
      'offset': offset,
      'position': position,
      'programId': programId,
  ...
  MusicResponse voicelist_detail(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/voicelist/detail",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse voice_delete(String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
  ...
  MusicResponse voice_upload(String voiceListId, String coverImgId,
      String categoryId, String secondCategoryId, String description,
      {String? songName,
      String? privacy,
      String? publishTime,
      String? autoPublish,
      String? autoPublishText,
      String? orderNo,
      String? composedSongs,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/voice/upload", cookie: cookie, env: env, query: {
  ...
  MusicResponse djRadio_top(
      ...
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/djRadio/top", cookie: cookie, env: env, query: {
      'djRadioId': djRadioId,
      'sortIndex': sortIndex,
  ...
  ///必选参数：
  ///id: 声音id
  MusicResponse voice_lyric(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/voice/lyric", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse verify_getQr(
      String vid, String type, String token, String evid, String sign,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/verify/getQr", cookie: cookie, env: env, query: {
      'vid': vid,
      'type': type,
      'token': token,
      'evid': evid,
  ...
  MusicResponse verify_qrcodestatus(String qr,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/verify/qrcodestatus",
        cookie: cookie, env: env, query: {'qr': qr});
  }
  ...
  MusicResponse audio_match(String duration, String audioFP,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/audio/match",
        cookie: cookie,
        env: env,
        query: {'duration': duration, 'audioFP': audioFP});
  }
  ...
  MusicResponse get_userids(String nicknames,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/get/userids",
        cookie: cookie, env: env, query: {'nicknames': nicknames});
  }
  ...
  MusicResponse ugc_album_get(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/ugc/album/get",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse ugc_song_get(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/ugc/song/get",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse ugc_artist_get(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/ugc/artist/get",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse ugc_mv_get(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/ugc/mv/get", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse ugc_artist_search(String keyword,
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/ugc/artist/search",
        cookie: cookie, env: env, query: {'keyword': keyword, 'limit': limit});
  }
  ...
  ///
  ///调用例子: /ugc/detail
  MusicResponse ugc_detail(String type,
      {String? limit,
      String? offset,
      String? auditStatus,
      String? order,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/ugc/detail", cookie: cookie, env: env, query: {
      'type': type,
      'limit': limit,
      'offset': offset,
  ...
  MusicResponse ugc_user_devote(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/ugc/user/devote", cookie: cookie, env: env);
  }
  ...
  MusicResponse summary_annual(String year,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/summary/annual",
        cookie: cookie, env: env, query: {'year': year});
  }
  ...
  MusicResponse search_match(
      String title, String album, String artist, String duration, String md5,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/search/match", cookie: cookie, env: env, query: {
      'title': title,
      'album': album,
      'artist': artist,
      'duration': duration,
  ...
  ///"sr": 采样率Sample Rate
  ///
  MusicResponse song_music_detail(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/music/detail",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse song_red_count(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/red/count",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse personal_fm_mode(String mode,
      {String? submode,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/personal/fm/mode",
        cookie: cookie, env: env, query: {'mode': mode, 'submode': submode});
  }
  ...
  MusicResponse album_privilege(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/album/privilege",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse artist_detail_dynamic(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/artist/detail/dynamic",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse recent_listen_list(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/recent/listen/list", cookie: cookie, env: env);
  }
  ...
  MusicResponse cloud_import(
      String song, String fileType, String fileSize, String bitrate, String md5,
      {String? id,
      String? artist,
      String? album,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/cloud/import", cookie: cookie, env: env, query: {
      'song': song,
      'fileType': fileType,
      'fileSize': fileSize,
      'bitrate': bitrate,
  ...
  MusicResponse song_download_url_v1(String id, String level,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/download/url/v1",
        cookie: cookie, env: env, query: {'id': id, 'level': level});
  }
  ...
  MusicResponse user_follow_mixed(
      {String? size,
      String? cursor,
      String? scene,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/follow/mixed",
        cookie: cookie,
        env: env,
        query: {'size': size, 'cursor': cursor, 'scene': scene});
  }
  ...
  ///
  ///调用例子 : /song/downlist
  MusicResponse song_downlist(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/song/downlist",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse song_monthdownlist(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/song/monthdownlist",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse song_singledownlist(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/song/singledownlist",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse song_like_check(String ids,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/like/check",
        cookie: cookie, env: env, query: {'ids': ids});
  }
  ...
  MusicResponse user_mutualfollow_get(String uid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/mutualfollow/get",
        cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  MusicResponse song_dynamic_cover(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/dynamic/cover",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse user_medal(String uid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/medal",
        cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  MusicResponse user_social_status(String uid,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/social/status",
        cookie: cookie, env: env, query: {'uid': uid});
  }
  ...
  MusicResponse user_social_status_support(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/social/status/support", cookie: cookie, env: env);
  }
  ...
  MusicResponse user_social_status_rcmd(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/social/status/rcmd", cookie: cookie, env: env);
  }
  ...
  MusicResponse user_social_status_edit(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/user/social/status/edit", cookie: cookie, env: env);
  }
  ...
  MusicResponse listen_data_year_report(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listen/data/year/report", cookie: cookie, env: env);
  }
  ...
  MusicResponse listen_data_today_song(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listen/data/today/song", cookie: cookie, env: env);
  }
  ...
  MusicResponse listen_data_total(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listen/data/total", cookie: cookie, env: env);
  }
  ...
  MusicResponse listen_data_realtime_report(String type,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/listen/data/realtime/report",
        cookie: cookie, env: env, query: {'type': type});
  }
  ...
  MusicResponse listen_data_report(String type,
      {String? endTime,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/listen/data/report",
        cookie: cookie, env: env, query: {'type': type, 'endTime': endTime});
  }
  ...
  MusicResponse playlist_import_name_task_create(
      {String? importStarPlaylist,
      String? playlistName,
      String? local,
      String? text,
      String? link,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/playlist/import/name/task/create",
        cookie: cookie,
        env: env,
        query: {
  ...
  MusicResponse playlist_import_task_status(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/import/task/status",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse song_chorus(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/chorus", cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse playlist_detail_rcmd_get(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/playlist/detail/rcmd/get",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse song_lyrics_mark(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/lyrics/mark",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse song_lyrics_mark_user_page(
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/song/lyrics/mark/user/page",
        cookie: cookie, env: env, query: {'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse song_lyrics_mark_add(String id, String data,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/lyrics/mark/add",
        cookie: cookie, env: env, query: {'id': id, 'data': data});
  }
  ...
  MusicResponse song_lyrics_mark_del(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/song/lyrics/mark/del",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse broadcast_category_region_get(
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/broadcast/category/region/get", cookie: cookie, env: env);
  }
  ...
  MusicResponse broadcast_channel_collect_list(
      {String? limit,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/broadcast/channel/collect/list",
        cookie: cookie, env: env, query: {'limit': limit});
  }
  ...
  MusicResponse broadcast_channel_currentinfo(String id,
      {Map<String, String> cookie = const {}, NcmProcessEnv? env}) {
    return request("/broadcast/channel/currentinfo",
        cookie: cookie, env: env, query: {'id': id});
  }
  ...
  MusicResponse broadcast_channel_list(
      {String? categoryId,
      String? regionId,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/broadcast/channel/list",
        cookie: cookie,
        env: env,
        query: {'categoryId': categoryId, 'regionId': regionId});
  }
  ...
  MusicResponse user_playlist_create(String uid,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/playlist/create",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'limit': limit, 'offset': offset});
  }
  ...
  MusicResponse user_playlist_collect(String uid,
      {String? limit,
      String? offset,
      Map<String, String> cookie = const {},
      NcmProcessEnv? env}) {
    return request("/user/playlist/collect",
        cookie: cookie,
        env: env,
        query: {'uid': uid, 'limit': limit, 'offset': offset});
  }
